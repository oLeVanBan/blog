CoolClock.config.skins = {
	...
	chunkySwissOnBlack: {
		outerBorder:      { lineWidth: 200, radius: 97, color: "black", alpha: 1 },
	...
	// by securephp
	securephp: {
		outerBorder:      { lineWidth: 100, radius: 0.45, color: "#E5ECF9", alpha: 1 },
	...
	Tes2: {
		outerBorder:      { lineWidth: 180, radius: 1, color: "#E5ECF9", alpha: 1 },
	...
	Cold: {
		outerBorder:      { lineWidth: 150, radius: 25, color: "white", alpha: 0.8 },
